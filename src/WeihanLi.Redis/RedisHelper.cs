...
namespace WeihanLi.Redis
{
    /// <summary>
    /// Redis 帮助类
    /// https://github.com/WeihanLi/StackExchange.Redis-docs-cn
    /// </summary>
    public static class RedisHelper
    {
        ...
        public static bool Set<T>(string key, T value, TimeSpan? expiration) =>
            Set(key, value.ToString(), expiration);
        ...
        public static Task<bool> SetAsync<T>(string key, T value, TimeSpan? expiration) =>
            SetAsync(key, value.ToJson(), expiration);
